    ...
    <div class="container">
        <div class="row" style="padding: 0px 12px 0 12px;">
            <div class="mx-auto col-md-6 mt-3">
                <img class="frm_com_logo" src="{{ getImage($company->logo) }}">
            </div>
            <div class="col-md-12">
                <h3>Application Form</h3>
                <p class=" text-danger mb-1">All fields with * are compulsory / * वाले सभी कॉलम अनिवार्य हैं
                </p>
            </div>
        </div>
    </div>
    <div class="container mb-1">
        <ul class="nav nav-pills steppers-list mb-1 mt-2" id="pills-tab" role="tablist">
            ...
            <li class="nav-item mt-1" role="presentation">
                <button class="nav-link btn btn-sm " id="pills-family-tab" data-bs-toggle="pill"
                    data-bs-target="#pills-family" disabled type="button" role="tab" aria-controls="pills-family"
                    aria-selected="true">Family Detail</button>
            </li>
            <li class="nav-item mt-1" role="presentation">
                <button class="nav-link btn btn-sm" disabled id="pills-address-tab" data-bs-toggle="pill"
                    data-bs-target="#pills-address" type="button" role="tab" aria-controls="pills-address"
                    aria-selected="false">Address</button>
            </li>
            <li class="nav-item mt-1" role="presentation">
                <button class="nav-link btn btn-sm" disabled id="pills-education-tab" data-bs-toggle="pill"
            ...
            <li class="nav-item mt-1" role="presentation">
                <button class="nav-link btn  btn-sm" disabled id="pills-work-experience-tab" data-bs-toggle="pill"
            ...
            <li class="nav-item mt-1" role="presentation">
                <button class="nav-link btn btn-sm" disabled id="pills-other-tab" data-bs-toggle="pill"
                    data-bs-target="#pills-other" type="button" role="tab" aria-controls="pills-other"
                    aria-selected="false">Other Information</button>
            </li>
            <li class="nav-item mt-1" role="presentation">
                <button class="nav-link btn btn-sm " disabled id="pills-document-tab" data-bs-toggle="pill"
        ...
        <div class="tab-content mt-0" id="pills-tabContent">
                ...
                <form id="personal_detail" data-url="{{ route('store-personal-detail') }}">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="form_category" class="select-2 form-select" id="form_category" required>
                                        <option value="">Select Position</option>
                                        @foreach (getCompanyRgCategories($find->company) as $cat)
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ $user->iti_college_name }}" class=" form-control"
                                        name="iti_college_name" id="iti_college_name" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="iti_trade" class=" select-2 form-select" id="iti_trade" required>
                    ...
                    <fieldset class=" mt-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mt-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="mother_tongue" id="mother_tongue" class="form-control"
                                        value="{{ $other->mother_tongue }}" required>
                            ...
                            <div class="col-md-4 mt-2">
                                <div class="form-group">
                                    <label>Marital Status / वैवाहिक स्थिति<span class="text-danger">*</span></label><br>
                                    <select class="form-select" name="marital_status" id="marital_status" required>
                                        <option value="Single" @selected($user->marital_status == 'Single')>Single / अविवाहित</option>
                                        <option value="Married" @selected($user->marital_status == 'Married')>Married / विवाहित</option>
                                    </select>
                            ...
                            <div class="col-md-4 mt-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="pan_card" id="pan_card" onkeyup="ValidatePAN();"
                                        value="{{ $user->pan_card }}" class="form-control"
            ...
            <div class="tab-pane fade" id="pills-family" role="tabpanel" aria-labelledby="pills-family-tab">
                <form action="javascript:void(0);" id="family_detail" data-url="{{ route('store-family-detail') }}">
                    <fieldset class="mt-3">
                        <legend>
                            <p>Family Details</p>
                        </legend>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="grandpa_profession" id="grandpa_profession"
                                                value="{{ $other->grandpa_profession }}" class=" form-control">
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <input type="text" name="grandpa_contact_no" id="grandpa_contact_no"
                                                value="{{ $other->grandpa_contact_no }}" class=" form-control">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>2</td>
                                        ...
                                        <td>
                                            <input type="text" name="grandmother_education" id="grandmother_education"
                                                value="{{ $other->grandmother_education }}" class=" form-control">
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <input type="text" name="grandmother_profession"
                                                id="grandmother_profession" value="{{ $other->grandmother_profession }}"
                                                class=" form-control">
                                        </td>
                                        <td>
                                            <input type="text" name="grandmother_income" id="grandmother_income"
                                                value="{{ $other->grandmother_income }}" class=" form-control">
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <input type="text" name="grandmother_other_income"
                                                ...
                                                value="{{ $other->grandmother_other_income }}" class=" form-control">
                                        </td>
                                        <td>
                                            <input type="text" name="grandmother_contact_no"
                                                id="grandmother_contact_no" value="{{ $other->grandmother_contact_no }}"
                                                class=" form-control">
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="father_occupation" id="father_occupation"
                                                value="{{ $user->father_occupation }}" required class=" form-control">
                                        </td>
                                        <td>
                                            <input type="text" name="father_annual_income" id="father_annual_income"
                                                value="{{ $user->father_annual_income }}" required class=" form-control">
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="guardian_education" id="guardian_education"
                                                value="{{ $other->guardian_education }}" class=" form-control">
                                        </td>
                                        <td>
                                    ...
                                    <tr class=" d-none depend_on_marital_status">
                                        ...
                                        <td>
                                            <input type="text" name="mother_in_law_name" id="mother_in_law_name"
                                                value="{{ $other->mother_in_law_name }}" class=" form-control">
                                        </td>
                                        <td>
                                            <input type="text" name="mother_in_law_education"
                                                id="mother_in_law_education"
                                                value="{{ $other->mother_in_law_education }}" class=" form-control">
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <input type="text" name="mother_in_law_profession"
                                                ...
                                                value="{{ $other->mother_in_law_profession }}" class=" form-control">
                                        </td>
                                        <td>
                                            <input type="text" name="mother_in_law_income" id="mother_in_law_income"
                                                value="{{ $other->mother_in_law_income }}" class=" form-control">
                                        </td>
                                        <td>
                                            <input type="text" name="mother_in_law_property"
                                                id="mother_in_law_property" value="{{ $other->mother_in_law_property }}"
                                                class=" form-control">
                                        </td>
                                        <td>
                                            <input type="text" name="mother_in_law_other_income"
                                                id="mother_in_law_other_income"
                                                value="{{ $other->mother_in_law_other_income }}" class="form-control">
                                        </td>
                                        <td>
                                            <input type="text" name="mother_in_law_contact_no"
                                                id="mother_in_law_contact_no"
                                                value="{{ $other->mother_in_law_contact_no }}" class=" form-control">
                                        </td>
                                    </tr>
                                    <tr class=" d-none depend_on_marital_status">
                                        <td>14</td>
                                        ...
                                        <td>
                                            <input type="text" name="father_in_law_name" id="father_in_law_name"
                                                value="{{ $other->father_in_law_name }}" class=" form-control">
                                        </td>
                                        <td>
                                            <input type="text" name="father_in_law_education"
                                                id="father_in_law_education"
                                                value="{{ $other->father_in_law_education }}" class=" form-control">
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <input type="text" name="father_in_law_profession"
                                                ...
                                                value="{{ $other->father_in_law_profession }}" class=" form-control">
                                        </td>
                                        <td>
                                            <input type="text" name="father_in_law_income" id="father_in_law_income"
                                                value="{{ $other->father_in_law_income }}" class=" form-control">
                                        </td>
                                        <td>
                                            <input type="text" name="father_in_law_property"
                                                id="father_in_law_property" value="{{ $other->father_in_law_property }}"
                                                class=" form-control">
                                        </td>
                                        <td>
                                            <input type="text" name="father_in_law_other_income"
                                                id="father_in_law_other_income"
                                                value="{{ $other->father_in_law_other_income }}" class="form-control">
                                        </td>
                                        <td>
                                            <input type="text" name="father_in_law_contact_no"
                                                id="father_in_law_contact_no"
                                                value="{{ $other->father_in_law_contact_no }}" class=" form-control">
                                        </td>
                                    </tr>
                                    <tr class=" d-none depend_on_marital_status">
                                        <td>15</td>
                                        ...
                                        <td>
                                            <input type="text" name="brother_in_law_education"
                                                ...
                                                value="{{ $other->brother_in_law_education }}" class=" form-control">
                                        </td>
                                        <td>
                                            <input type="text" name="brother_in_law_age" id="brother_in_law_age"
                                                value="{{ $other->brother_in_law_age }}" class=" form-control">
                                        </td>
                                        <td>
                                            <input type="text" name="brother_in_law_profession"
                                                id="brother_in_law_profession"
                                                value="{{ $other->brother_in_law_profession }}" class=" form-control">
                                        </td>
                                        <td>
                                            <input type="text" name="brother_in_law_income" id="brother_in_law_income"
                                                value="{{ $other->brother_in_law_income }}" class=" form-control">
                                        </td>
                                        <td>
                                            <input type="text" name="brother_in_law_property"
                                                id="brother_in_law_property"
                                                value="{{ $other->brother_in_law_property }}" class=" form-control">
                                        </td>
                                        <td>
                                            <input type="text" name="brother_in_law_other_income"
                                                id="brother_in_law_other_income"
                                                value="{{ $other->brother_in_law_other_income }}" class="form-control">
                                        </td>
                                        <td>
                                            <input type="text" name="brother_in_law_contact_no"
                                                id="brother_in_law_contact_no"
                                                value="{{ $other->brother_in_law_contact_no }}" class=" form-control">
                                        </td>
                                    </tr>
                                    <tr class=" d-none depend_on_marital_status">
                                        <td>16</td>
                                        ...
                                        <td>
                                            <input type="text" name="sister_in_law_name" id="sister_in_law_name"
                                                value="{{ $other->sister_in_law_name }}" class=" form-control">
                                        </td>
                                        <td>
                                            <input type="text" name="sister_in_law_education"
                                                id="sister_in_law_education"
                                                value="{{ $other->sister_in_law_education }}" class=" form-control">
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <input type="text" name="sister_in_law_profession"
                                                ...
                                                value="{{ $other->sister_in_law_profession }}" class=" form-control">
                                        </td>
                                        <td>
                                            <input type="text" name="sister_in_law_income" id="sister_in_law_income"
                                                value="{{ $other->sister_in_law_income }}" class=" form-control">
                                        </td>
                                        <td>
                                            <input type="text" name="sister_in_law_property"
                                                id="sister_in_law_property" value="{{ $other->sister_in_law_property }}"
                                                class=" form-control">
                                        </td>
                                        <td>
                                            <input type="text" name="sister_in_law_other_income"
                                                id="sister_in_law_other_income"
                                                value="{{ $other->sister_in_law_other_income }}" class="form-control">
                                        </td>
                                        <td>
                                            <input type="text" name="sister_in_law_contact_no"
                                                id="sister_in_law_contact_no"
                                                value="{{ $other->sister_in_law_contact_no }}" class=" form-control">
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="rel_buss_gov_emp" id="rel_buss_gov_emp" class=" form-select">
                                        ...
                                        <option value="Police Service" @selected($other->rel_buss_gov_emp == 'Police Service')> Police Service
                                        </option>
                                        ...
                                        <option value="Lawyer" @selected($other->rel_buss_gov_emp == 'Lawyer')>Lawyer / वकील</option>
                                        <option value="Bureaucracy" @selected($other->rel_buss_gov_emp == 'Bureaucracy')>Bureaucracy / नौकरशाही
                                        </option>
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class=" text-center">
                        <a href="#" class="btn btn-custom-2 btn-prev-tab btn-radius py-1"
                            onclick="previousTab('pills-personal-detail-tab')"><i class="bx bx-skip-previous"></i> Prev
                            Step</a>
                ...
                <form id="address_detail" data-url="{{ route('store-address-detail') }}">
                    <fieldset class="mt-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mt-2">
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" name="permanent_state" id="permanent_state"
                                            required>
                                ...
                                <div class="col-md-4 mt-2">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="permanent_pincode" name="permanent_pincode"
                                            value="{{ $user->permanent_pincode }}" class="form-control " required>
                                ...
                                <div class="col-md-4 mt-2">
                                    <div class="form-group">
                                        <label>Landline/Mobile / लैंडलाइन/मोबाइल<span class="text-danger">*</span></label>
                                        <input type="number" id="permanent_landline_mobile"
                                            name="permanent_landline_mobile"
                                            value="{{ $other->permanent_landline_mobile }}" class="form-control"
                                            required>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="present_house_number" class="form-control"
                                            id="present_house_number" value="{{ $user->present_house_number }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" name="present_state" id="present_state">
                                            ...
                                            @foreach ($states as $state)
                                                <option value="{{ $state->id }}" @selected($user->present_state == $state->id)>
                                                    {{ $state->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-4 mt-2">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="present_landline_mobile"
                                            ...
                                            value="{{ $other->present_landline_mobile }}" class="form-control">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mt-2">
                                <div class="form-group">
                                    <label>Years spent in hostel/relatives / <br> हॉस्टल/रिश्तेदारों में बिताए साल</label>
                    ...
                    <div class="col-12 text-center">
                        <a href="#" class="btn btn-custom-2 btn-prev-tab btn-radius py-1 previous_btn"
                            onclick="previousTab('pills-family-tab')"><i class="bx bx-skip-previous"></i> Prev Step</a>
            ...
            <div class="tab-pane fade" id="pills-education" role="tabpanel" aria-labelledby="pills-education-tab">
                <form id="education_detail" data-url="{{ route('store-education-detail') }}">
                    <fieldset class="mt-3">
                        <fieldset>
                            ...
                            <div class="row">
                                <div class="col-md-4 mt-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="tenth_college_name" id="tenth_college_name"
                                            value="{{ $user->tenth_college_name }}" class="form-control" required>
                                ...
                                <div class="col-md-4 mt-1">
                                    <div class="form-group">
                                        <label>Month & Year of Passing / पास होने का महीना और वर्ष<span
                                                class="text-danger">*</span></label>
                                        <input type="month" name="tenth_passing_year" id="tenth_passing_year"
                                            value="{{ $user->tenth_passing_year }}" class="form-control" required>
                                ...
                                <div class="col-md-4 mt-1">
                                    <div class="form-group">
                                        <label>Obtained Marks / पाया हुआ मार्क्स<span class="text-danger">*</span></label>
                                        <input type="text" name="tenth_obtain_mark" id="tenth_obtain_mark"
                                            value="{{ $other->tenth_obtain_mark }}" class="form-control" required>
                                ...
                                <div class="col-md-4 mt-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="tenth_max_mark" id="tenth_max_mark"
                                            value="{{ $other->tenth_max_mark }}" class="form-control" required>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mt-1">
                                    <div class="form-group">
                                        ...
                                        <input type="month" name="twelve_passing_year" id="twelve_passing_year"
                                            value="{{ $user->twelve_passing_year }}" class="form-control">
                                        <span class="invalid-feedback d-none twelve_passing_year" role="alert">
                                ...
                                <div class="col-md-4 mt-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="twelve_obtain_mark" id="twelve_obtain_mark"
                                            value="{{ $other->twelve_obtain_mark }}" class="form-control">
                        ...
                        <fieldset class="mt-3">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-select" name="any_other_graduation" id="any_other_graduation"
                                        required>
                            ...
                            <div class="row d-none any_other_grd_wrapper">
                                <div class="col-md-4 mt-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="other_college_name" id="other_college_name"
                                            value="{{ $user->other_college_name }}" class="form-control">
                                ...
                                <div class="col-md-4 mt-1">
                                    <div class="form-group">
                                        <label>Month & Year of Passing / पास होने का महीना और वर्ष</label>
                                        <input type="month" name="other_passing_year" id="other_passing_year"
                                            value="{{ $user->other_passing_year }}" class="form-control">
                            ...
                            <div class="row ">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="institution_address" id="institution_address"
                                            value="{{ $other->institution_address }}" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>University Name and address</label>
                                        <input type="text" name="ot_grad_uni_na_adr" id="ot_grad_uni_na_adr"
                                            value="{{ $other->ot_grad_uni_na_adr }}" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select name="other_grad_program" id="other_grad_program"
                                            ...
                                            <option value="Full Time" @selected($other->other_grad_program == 'Full Time')>Full Time</option>
                                            <option value="Pasrt Time" @selected($other->other_grad_program == 'Pasrt Time')>Pasrt Time</option>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="other_grad_enrol_no" id="other_grad_enrol_no"
                                            value="{{ $other->other_grad_enrol_no }}" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Type of degree</label>
                                        <input type="text" name="other_grad_deg_type" id="other_grad_deg_type"
                                            value="{{ $other->other_grad_deg_type }}" class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                        ...
                        <fieldset class="mt-3">
                            ...
                            <div class="row">
                                <div class="col-md-4 mt-1">
                                    <div class="form-group">
                                        <label>ITI College (आई. टी. आई. कॉलेज)<span class="text-danger">*</span></label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" name="iti_start_from" id="iti_start_from"
                                            ...
                                            @for ($i = date('Y'); $i >= 1980; $i--)
                                                <option value="{{ $i }}" @selected($other->iti_start_from == $i)>
                                                    {{ $i }}
                                                </option>
                                            @endfor
                                        </select>
                                ...
                                <div class="col-md-4 mt-1">
                                    <div class="form-group">
                                        ...
                                        <select class="form-select" name="iti_start_to" id="iti_start_to" required>
                                            <option value="">Select Start Year</option>
                                            @for ($i = date('Y'); $i >= 1980; $i--)
                                                <option value="{{ $i }}" @selected($other->iti_start_to == $i)>
                                                    {{ $i }}
                                                </option>
                                            @endfor
                                        </select>
                                ...
                                <div class="col-md-4 mt-2">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="iti_attendance_reason"
                                            value="{{ $other->iti_attendance_reason }}" id="iti_attendance_reason"
                                            class="form-control">
                                ...
                                <div class="row d-none" id="apprentice_Wrapper">
                                    <div class="col-md-4 mt-1">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="apprentice_company_name"
                                                ...
                                                value="{{ $user->apprentice_company_name }}" class="form-control">
                                    ...
                                    <div class="col-md-4 mt-1">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="apprentice_start_date"
                                                value="{{ $user->apprentice_start_date }}" id="apprentice_start_date"
                                                class="form-control">
                                            <span class="invalid-feedback d-none apprentice_start_date" role="alert">
                                    ...
                                    <div class="col-md-4 mt-1">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="apprentice_end_date"
                                                value="{{ $user->apprentice_end_date }}" id="apprentice_end_date"
                                                class="form-control">
                                            <span class="invalid-feedback d-none apprentice_end_date" role="alert">
                                    ...
                                    <div class="col-md-4 mt-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="apprentice_division" id="apprentice_division"
                                                value="{{ $user->apprentice_division }}" class="form-control">
                                            <span class="invalid-feedback d-none apprentice_division" role="alert">
                        ...
                        <fieldset class="mt-3">
                            ...
                            <div class="row d-none" id="diploma_Wrapper">
                                ...
                                <div class="col-md-4 mt-1">
                                    <div class="form-group">
                                        <label>From</label>
                                        <select class="form-select" name="diploma_start_from" id="diploma_start_from">
                                            <option value="">Select Start Year</option>
                                            @for ($i = date('Y'); $i >= 1980; $i--)
                                                <option value="{{ $i }}" @selected($other->diploma_start_from == $i)>
                                                    {{ $i }}
                                                </option>
                                            @endfor
                                        </select>
                                ...
                                <div class="col-md-4 mt-1">
                                    <div class="form-group">
                                        <label>To</label>
                                        <select class="form-select" name="diploma_start_to" id="diploma_start_to">
                                            <option value="">Select Start Year</option>
                                            @for ($i = date('Y'); $i >= 1980; $i--)
                                                <option value="{{ $i }}" @selected($other->diploma_start_from == $i)>
                                                    {{ $i }}
                                ...
                                <div class="col-md-4 mt-2">
                                    <div class="form-group">
                                        <label>Branch</label>
                                        <input type="text" name="diploma_trade_branch" id="diploma_trade_branch"
                                            value="{{ $other->diploma_trade_branch }}" class=" form-control">
                                        <span class="invalid-feedback d-none diploma_trade_branch" role="alert">
                            ...
                            <div class="col-md-4 mt-2">
                                <div class="form-group">
                                    ...
                                    <select name="comp_know" id="comp_know" class=" form-select">
                                        ...
                                        <option value="Proficient" @selected($other->comp_know == 'Proficient')> Proficient</option>
                                        ...
                                        <tr>
                                            <td class=" d-flex align-items-center">Other: <div class="col-8"
                                                    style="margin-left: 10px;"><input type="text" name="other_lang"
                                                        id="other_lang" value="{{ $other->other_lang }}"
                    ...
                    <div class="col-12 text-center">
                        <a href="#" class="btn btn-custom-2 btn-prev-tab btn-radius py-1"
                            onclick="previousTab('pills-address-tab')"><i class="bx bx-skip-previous"></i> Prev Step</a>
                        <button type="submit" class="btn btn-custom-2">
                            Next Step <i class="bx bx-skip-next"></i>
                        </button>
                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select name="previous_com_cert" id="previous_com_cert"
                                                        class=" form-select">
                                                        <option value="NO" @selected($other->previous_com_cert == 'NO')>No</option>
                                                        <option value="YES" @selected($other->previous_com_cert == 'YES')>Yes</option>
                                                    </select>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <select name="previous_com_cert_two" id="previous_com_cert_two"
                                                        class=" form-select">
                                                        <option value="NO" @selected($other->previous_com_cert_two == 'NO')>No</option>
                                                        <option value="YES" @selected($other->previous_com_cert_two == 'YES')>Yes</option>
                                                    </select>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="date" name="previous_company_start_date_three"
                                                ...
                                                <td>
                                                    <input type="text" name="previous_company_res_living_three"
                                                        value="{{ $other->previous_company_res_living_three }}"
                                                        class="form-control">
                                                </td>
                                                <td>
                                                    <select name="previous_com_cert_three" id="previous_com_cert_three"
                                                        class=" form-select">
                                                        <option value="NO" @selected($other->previous_com_cert_three == 'NO')>No</option>
                                                        <option value="YES" @selected($other->previous_com_cert_three == 'YES')>Yes</option>
                                                    </select>
                                                </td>
                                            </tr>
                                        </tbody>
            ...
            <div class="tab-pane fade" id="pills-other" role="tabpanel" aria-labelledby="pills-other-tab">
                <form id="other_info_detail" data-url="{{ route('store-other-info-detail') }}">
                        ...
                        <div class="row">
                            <div class="col-md-4 mt-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="your_major_achievement"
                                        value="{{ $other->your_major_achievement }}" id="your_major_achievement"
                                        class="form-control">
                            ...
                            <div class="col-md-4 mt-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="your_hobbies" value="{{ $other->your_hobbies }}"
                                        id="your_hobbies" class="form-control">
                            ...
                            <div class="col-md-4 mt-2">
                                <div class="form-group">
                                    <label>Do you know four wheeler driving? / क्या आप चार पहिये वाली गाड़ी चलाना
                                        जानते
                                        हैं : </label>
                                    <select class="form-select car_driving " name="car_driving" id="car_driving">
                            ...
                            <div class="col-md-12 mt-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="mobile_uses" value="{{ $other->mobile_uses }}"
                                        id="mobile_uses" class="form-control">
                            ...
                            <div class="col-md-12 mt-2">
                                <div class="form-group">
                                    <label>For what do you use the internet on the mobile phone? <br> आप फोन पर इंटरनेट का
                                        उपयोग
                                        किस
                                        लिए करते हैं?</label>
                            ...
                            <div class="col-md-12 mt-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="detail_of_past_surgery"
                                        value="{{ $user->detail_of_past_surgery }}" id="detail_of_past_surgery"
                                        class="form-control">
                            ...
                            <div class="col-md-6 mt-2 d-none have_you_appeared_this_com_detail">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="have_you_appeared_this_com_detail"
                                        value="{{ $other->have_you_appeared_this_com_detail }}" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6  mt-2">
                                <div class="form-group">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" name="resp_per_name_one"
                                                        value="{{ $other->resp_per_name_one }}" class="form-control">
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <input type="text" name="resp_per_cont_one"
                                                        value="{{ $other->resp_per_cont_one }}" class="form-control">
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" name="resp_per_name_two"
                                                        value="{{ $other->resp_per_name_two }}" class="form-control">
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <input type="text" name="resp_per_cont_two"
                                                        value="{{ $other->resp_per_cont_two }}" class="form-control">
                                                </td>
                                                <td>
                    ...
                    <div class="col-12 text-center">
                        <a href="#" class="btn btn-custom-2 btn-prev-tab btn-radius py-1"
                            onclick="previousTab('pills-work-experience-tab')"><i class="bx bx-skip-previous"></i> Prev
                            Step</a>
                        <button type="submit" class="btn btn-custom-2">
                            Next Step <i class="bx bx-skip-next"></i>
                        </button>
                ...
                <form id="doc_detail" data-url="{{ route('store-document-detail') }}">
                    <fieldset>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mt-2">
                                <div class="form-group">
                                    <label>ITI Certificate / ITI प्रमाण पत्र <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6 mt-2">
                                <div class="form-group">
                                    ...
                                    <input type="file" name="other_graduation_file" id="other_graduation_file"
                                        class="form-control">
                    ...
                    <fieldset class="mt-2">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="form-check">
                                        ...
                                        <label for="i_agree">
                                            I hereby confirm that the particulars given above are true and complete to the
                                            best
                                            of my knowledge and belief. If these are found to be incorrect or incomplete,
                                            the
                                            Company
                                            entitled to cancel/terminate my training and cancel my appointment.
                                            <br>
                                            मैं एतद्द्वारा पुष्टि करता हूं कि ऊपर दिए गए विवरण मेरे सर्वोत्तम ज्ञान और
                                            विश्वास
                                            के अनुसार सत्य और पूर्ण हैं। यदि ये गलत या अपूर्ण पाए जाते हैं, तो कंपनी
                                            मेरे प्रशिक्षण को रद्द/समाप्त करने और मेरी नियुक्ति रद्द करने का हकदार है।
                                        </label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 text-center">
                                <a href="#" class="btn btn-custom-2 btn-prev-tab btn-radius py-1"
                                    onclick="previousTab('pills-other-tab')"><i class="bx bx-skip-previous"></i> Prev
                                    Step</a>
