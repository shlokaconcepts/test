            ...
            <form class="card border border-success" id="interview_submit_form">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="form-group" style="text-align:left">
                                <textarea name="physical_appearance" rows="2"
                                    cols="20" class="form-control" style="height:50px;"></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="form-group" style="text-align:left">
                                <textarea name="communication"  rows="2"
                                    cols="20"class="form-control" style="height:50px;"></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="form-group" style="text-align:left">
                                <textarea name="family_background"rows="2"
                                    cols="20" class="form-control" style="height:50px;"></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="form-group" style="text-align:left">
                                <select name="subject_knowledge" class="form-control">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="form-group" style="text-align:left">
                                <label class="form-label ">Interviewer Remarks <span class="required">*</span>
                                    :</label>
                                <div class="form-control-wrapper">
                                    <textarea required name="remark" rows="1" cols="20"
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-control-wrapper">
                                    <select required name="status" class="form-control">
                                        ...
                                        <option value="Rejected">NOT OK</option>
