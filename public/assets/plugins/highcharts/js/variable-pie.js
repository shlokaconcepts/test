(function (b) {
    ...
    b = b ? b._modules : {};
    g(b, "Series/VariablePieSeries.js", [b["Core/Globals.js"], b["Core/Utilities.js"]], function (b, d) {
        var g = d.arrayMax,
            n = d.arrayMin,
            w =
            d.clamp,
        ...
        d("variablepie", "pie", {
            ...
            calculateExtremes: function () {
                ...
                c.length && (a = p(b.zMin, n(c.filter(this.zValEval))), c = p(b.zMax, g(c.filter(this.zValEval))), this.getRadii(a, c, this.minPxSize, this.maxPxSize))
            },
            getRadii: function (a,
                b, c, d) {
                var l = 0,
            ...
            translate: function (a) {
                ...
                for (k = 0; k < h; k++) {
                    ...
                    e = (r + e) / 2;
                    e > 1.5 * Math.PI ?
                        e -= 2 * Math.PI : e < -Math.PI / 2 && (e += 2 * Math.PI);
                    f.slicedTranslation = {
