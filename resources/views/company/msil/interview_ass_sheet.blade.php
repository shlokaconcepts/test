        ...
        <div class="mainwrapper" style="border:2px solid #333;padding:10px">
            ...
            <div class="pagehead">
                <div class="pageheadcol1">
                    <b><u>Interview Assessment Sheet</u></b> <br><span> <span
                            id="lblRegistrationType">{{$user->cat_name }}</span></span>
                </div>
            </div>
                                ...
                                <table cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td class="intercoltwo">
                                            <span
                                                id="lblInterviewLocation">{{ $admin['hr_location'] }}</span>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="intercoltwo" style="border-right:1px solid #333">
                                            <span id="lblNameofCandidate">{{ $user->full_name }}</span>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="intercoltwo" style="border-right:1px solid #333">
                                            <span id="lblITITrade">{{ $user->trade_name }}</span>
                                        </td>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="interquescoltwo"><span
                                        id="lblAPhysicalAppearanc">{{ $user->physical_appearance }}</span></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="interquescoltwo"><span
                                        id="lblACommunication">{{ $user->communication }}</span></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="interquescoltwo"><span
                                        id="lblAFamilyBackground">{{ $user->family_background }}</span></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="interquescoltwo"><span
                                        id="lblBSubjectKnowledge">{{ $user->subject_knowledge }}</span></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="interquescoltwo"><span
                                        id="lblBFamilyBackground">{{ $user->previous_experience }}</span></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="interquescoltwo"><span
                                        id="lblCDiscipline">{{ $user->discipline }}</span></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="interquescoltwo"><span
                                        id="lblCPositiveAttitude">{{ $user->positive_attitude }}</span></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="interquescoltwo"><span
                                        id="lblCNeedforJob">{{ $user->need_for_job }}</span></td>
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="indmaincolone"> <span
                                        id="lblInterviewRemarks">{{ $user->remark }}</span> </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="indcoltwo" style="border-bottom:none; text-align:center">
                                                        <img id="ImgInterviewer1"
                                                            ...
                                                            border-width: 0px;
                                                            height: 54px;"
                                                            src="{{ getImage($admin['hr_sig']) }}">
                                                        <span
                                                            id="lblInterviewer1">{{$admin['hr_name'] }}</span>
                                                ...
                                                <td class="indcolthree" style="border-bottom:none; text-align:center">
                                                    <img id="ImgInterviewer1"
                                                            ...
                                                            border-width: 0px;
                                                            height: 54px;"
                                                            src="{{ getImage($admin['tech_sig']) }}">
                                                        <span
                                                            id="lblInterviewer1">{{$admin['tech_name'] }}</span>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                ...
                                <td class="indmaincolthree"> <span
                                        id="lblInterviewResult">{{ $user->status == 'ok' ? 'Selected' : $user->status }}</span>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                                    ...
                                    <table cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td class="detailcolseven" colspan="2"> <span
                                                    id="lblDomicileState">{{ getStateName($user->state_name) }}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td colspan="7">
                                                <div class="headbox" style="border-left:none;border-right:none">
                                                    Assessment Details - <span
                                                        id="lblTrade">{{$user->trade_name }}</span>
