                ...
                <div class="">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Selected Candidates
                            </li>
                        </ol>
                    </nav>
                </div>
    ...
    <script>
        $(function() {
            ...
            $('#clear_filter').on('click', function() {
                ...
                $('#unique_id').val('');
                window.LaravelDataTables["onboardingunapprovedcandidatesdatatable-table"].draw();
            });
            $("#Filter_btn").click(() => {
                window.LaravelDataTables["onboardingunapprovedcandidatesdatatable-table"].draw();
            });
            $('#onboardingunapprovedcandidatesdatatable-table').on('draw.dt', function() {
                $('.dt_searching_wrapper').html('');
                $('.dt_searching_wrapper').html(`${$('.dataTables_info').html()}`);
            });

            $('#onboardingunapprovedcandidatesdatatable-table').on('preXhr.dt', function(e, settings, data) {
